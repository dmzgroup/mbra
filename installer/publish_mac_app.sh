...
echo "scp $VERSION_XML update.dmzdev.org:/home/update.dmzdev.org/public/latest/macos-$CHANNEL/MBRA.xml"
scp $VERSION_XML update.dmzdev.org:/home/update.dmzdev.org/public/latest/macos-$CHANNEL/MBRA.xml
