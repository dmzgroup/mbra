...
//   Q_INIT_RESOURCE (mbra);
   ...
   logObs.set_level (string_to_log_level (get_env ("MBRA_LOG_LEVEL")));
   ...
   QSettings settings;
   String workingDir (get_env ("MBRA_WORKING_DIR"));
         ...
         if (global.lookup_all_config_merged ("manifest", manifest)) {
            ...
            if (!rcc) {
               ...
               rcc = config_to_string (
                  "resource.file", manifest, String (MBRAApplicationName) + ".rcc");
            }
